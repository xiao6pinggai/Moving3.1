...
def main():
    ...
    # 使用示例
    # pred_json_path = "map_out/coco_eval_sdmcar2/eval_results.json"
    pred_json_path = 'runs/detect/yolo26mval/exp_rscarnew_yolo26m/predictions.json'
    ...
    # save_path = f"map_out/coco_eval_sdmcar2/{time_str}_{dataname}_{model_name}_{pred_json_name}"
    save_path = f"runs/detect/yolo26mval/exp_rscarnew_yolo26m/{time_str}_{dataname}_{model_name}_{pred_json_name}"
    threshold = 0
    topk = 128
    # topk = 360
