...
class TSC3D_Block(Module):
    ...
    def forward(self, x):
        ...
        return self.tsc(self.conv2(self.conv1(x)))
...
class UNet3DWithTSC3D(Module):
    def __init__(self, num_channels=3, num_classes=1, feat_channels=[32,64,128,256], residual=None, 
        ...
        # 编码器：卷积块
        self.enc_conv1 = TSC3D_Block(num_channels, feat_channels[0], kernel=3, stride=1, padding=1, bias=False)
